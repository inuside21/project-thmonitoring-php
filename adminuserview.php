...
<html lang=en>
    ...
    <body>
                ...
                <div class=content>
                    <div class=content-header>
                        ...
                        <div class=header-title>
                            ...
                            <small><span id='bDisplayBuildingName'></span></small>
                            <ol class=breadcrumb>
        ...
        <script>
                ...
                $('#fSubmit').click(function(e) {
                    ...
                    swal(
                        ...
                        function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "server/api.php?mode=useredit",
                ...
                $('#fDelete').click(function(e) {
                    ...
                    swal(
                        ...
                        function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "server/api.php?mode=userdelete",
                                data: $("#fInfo").serialize(),
                                beforeSend: function() {
                                    // button
                                    $('#fButton').toggle();
            ...
            $.ajax({
                type: "POST",
                url: "server/api.php?mode=userview",
                data: {
                ...
                success: function(data) {
                    ...
                    {
                        // display
                        $('#bDisplayName').text(result.data.user_fname);
                        //$('#bDisplayBuildingName').text(result.message.building_name);

                        console.log(result.data);
                        // input
                        $('#rUname').val(result.data.user_uname);
                        $('#rPass').val(result.data.user_pword);
